...
object BlockIndexTableModel extends AbstractTableModel {
	var handler:BlockIndexHandler=_
	var ixList: Array [(Int,Long)]=Array ()

	def setTypeHandler(nhandler:BlockIndexHandler): Unit =  {
		handler=nhandler
		readTheList()
	}
	...
	def getValueAt(rowIndex: Int, columnIndex: Int): Object =  {
		...
		columnIndex match 	{
			case 0 => java.lang.Integer.valueOf(rowIndex)
			case 1 => a._1.toString
			case 2 => a._2.toString
		}
	}
