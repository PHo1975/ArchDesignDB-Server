...
trait CustomQuestionHandler {
  ...
  def singlePointQuestion(actionText: String, questionText: String, strict: Option[Boolean], repeat: Boolean = false): DialogQuestion =
  ...
  def singleNumberQuestion(actionText: String, questionText: String, repeat: Boolean = false): DialogQuestion = DialogQuestion(actionText, Seq(new AnswerDefinition(questionText, DataType.DoubleTyp, None)), repeat)

  def singleTextQuestion(actionText: String, questionText: String, repeat: Boolean = false): DialogQuestion = DialogQuestion(actionText, Seq(new AnswerDefinition(questionText, DataType.StringTyp, None)), repeat)

  def singleIntQuestion(actionText: String, questionText: String, repeat: Boolean = false): DialogQuestion = DialogQuestion(actionText,
